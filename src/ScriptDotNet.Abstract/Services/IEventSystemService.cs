// -----------------------------------------------------------------------
// <copyright file="IEventSystemService.cs" company="ScriptDotNet">
...
namespace ScriptDotNet.Services
{
    public interface IEventSystemService
    {
        ...
        [Obsolete("DrawGamePlayer deprecated, use DrawObject!")]
        ...
        [Obsolete("ClilocSpeechAffix deprecated, use ClilocSpeech!")]
        event EventHandler<ClilocSpeechAffixEventArgs> ClilocSpeechAffix;

        [Obsolete("UnicodeSpeech deprecated, use Speech!")]
