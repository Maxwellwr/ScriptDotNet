// -----------------------------------------------------------------------
// <copyright file="GumpInfo.cs" company="ScriptDotNet">
...
{
    public struct GumpInfo : IDeserialized
    {
        ...
        public void Deserialize(BinaryReader br)
        {
            ...
            if (len > 0)
            {
                ...
                for (var i = 0; i < len; i++)
                {
                    ...
                    string msg = Encoding.Unicode.GetString(br.ReadBytes((int)paramLength * sizeof(char)), 0, (int)paramLength * sizeof(char));
                    Text[i] = msg;
                }
            }
